...
class MainViewController:UIViewController{
    ...
    var diyiscore:ScoreView!
    var dierscore:ScoreView!
    var disanscore:ScoreView!
    ...
    {
        super.viewDidLoad()
        self.view.backgroundColor = UIColor(red: 255.0/255.0, green: 255.0/255.0, blue: 224.0/255.0, alpha: 1.0)
        setupBackground()
        setupButtons()
        setupSwipeGuestures()
        setupScoreLabels()
    ...
    {
        let cv = ControlView()
        let btnreset = cv.createButton("新游戏", action: Selector("resetTapped"), sender: self)
        ...
        let chexiao = cv.createButton("撤销", action: Selector("chexiao"), sender: self)
        chexiao.frame.origin.x = 110
        chexiao.frame.origin.y = 500
        self.view.addSubview(chexiao)
    }
    ...
    func setupBackground()
    {
        ...
        for _ in 0..<dimension
        {
            ...
            for _ in 0..<dimension
            {
                ...
                background.backgroundColor = UIColor(red: 232.0/255.0, green: 232.0/255.0, blue: 232.0/255.0, alpha: 1.0)
